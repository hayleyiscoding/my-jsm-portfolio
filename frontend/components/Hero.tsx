...
const Hero = () => {
  return (
    <section
      id='hero'
      className='dark:bg-custom-black mb-8 mt-5 rounded-2xl bg-white py-8 dark:p-0'
    >
          ...
          <div className='lg-order-1 order-2 p-5 pt-10'>
            ...
            <div>
              <Link
                ...
                target='_blank'
                className='bg-custom-red border-custom-black mt-12 flex w-full cursor-pointer items-center justify-center rounded-lg border px-6 py-[19px] text-sm font-medium leading-5 text-white transition-all duration-200 hover:text-white hover:opacity-70 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 dark:border-white dark:hover:bg-black lg:w-auto'
              >
                Download Resume
                <AiOutlineCloudDownload size={20} className='ml-2' />
              </Link>
              <div className='border-custom-red text-custom-black ml-0 mt-4 flex w-full cursor-pointer items-center justify-center rounded-lg border px-6 py-[21px] text-sm font-medium leading-5 transition-all duration-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 dark:border-white dark:text-white lg:w-auto'>
